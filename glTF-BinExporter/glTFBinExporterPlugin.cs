...
namespace glTF_BinExporter
{
    ...
    public class glTFBinExporterPlugin : Rhino.PlugIns.FileExportPlugIn
    {
        ...
        public const bool UseDisplayColorForUnsetMaterialsDefault = false;
        ...
        {
            get => Instance.Settings.GetBool(FlipMirroredNormalsDialogKey, FlipMirroredNormalsDialogDefault);
